...
def check(file_c, num_img, pname):
    ...
    if file_count<40 and number_of_images<170:
        print("Re Downloading.........Hi Anurag I AM DOWNLOADING.............",person)
        time.sleep(2)
...
for name,num in zip(name_list,folder_num):
    SRC_PATH = './female_download_wed_24/'+str(num).zfill(4)+'/'
    DST_PATH = './female_crop_status_wed_24/'+str(num).zfill(4)+'/'
    number_of_images = 80
